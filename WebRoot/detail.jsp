                    ...
                    <div id="jingdong">
                        ...
                        <div class="xiaotu">
                            ...
                            <div class="tu">
                                <ul>
                                    <li>
                                        <img src="${shop }/image/0.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/1.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/2.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/3.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/4.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/5.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/6.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/7.png" />
                                    </li>
                                    <li>
                                        <img src="${shop }/image/8.png" />
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="product_rightcol fr">
                    ...
                    <ul id="summary">
                        <li id="summary-market">
                            ...
                            <div class="dd"> <del id="page_maprice">￥299.0</del>
                            </div>
                        </li>
                        <li id="summary-price">
                            ...
                            <div class="dd">
                                <div class="item">
                                    ...
                                    <a href="#none" title="白色">
                                        <img data-img="1" src="${shop }/image/11.jpg" width="25" height="25" alt="白色 "> <i>白色</i>
                                    </a>
                                </div>
                                <div class="item  selected">
                                    <b></b>
                                    <a href="#none" title="黑色">
                                        <img data-img="1" src="${shop }/image/22.jpg" width="25" height="25" alt="黑色 "> <i>黑色</i>
                                    </a>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="add_to_buttons">
                        <button class="add_cart">
                        	<a href="${shop }/sorder/addSorder.action?id=${product.id}">加入购物车</a>
                        </button>
                    </div>
                </div>
                <!--详情右侧结束--> </div>
